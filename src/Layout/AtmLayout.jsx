...
const AtmLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-[#D24545] flex justify-center flex-col  items-center">
      ...
      <div className="w-full md:w-[60%] lg:w-[40%] xl:w-[30%] h-auto bg-red-100 px-3 mb-5">
        <div className="flex justify-between pt-5">
          <Button text="Withdraw" onClick={handleToggle} bgColor="#f56565"/>
          <Button text="Deposit" onClick={handleToggle} bgColor="#48bb78"/>
        </div>
